...
某些场景下模块要使用的静态文件文件与模板文件（例如有一个很长的脚本文件要配置给 [`user_data`](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/linux_virtual_machine#user_data)，保存在 `files` 目录下。
